  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <button
        ...
        className="flex h-11 items-center justify-center rounded-control bg-accent px-5 text-base font-medium text-white hover:bg-accent-hover active:bg-accent-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-focus disabled:opacity-50"
      >
        Finish Workout
      </button>
