      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <Link
            ...
            className="flex h-11 w-11 items-center justify-center rounded-control bg-accent text-white hover:bg-accent-hover active:bg-accent-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-focus md:hidden"
          >
            <Plus className="h-4 w-4" aria-hidden="true" />
          </Link>
          <Link
            href="/workouts/new?from=library"
            className="hidden h-11 items-center justify-center rounded-control bg-accent px-4 text-base text-white hover:bg-accent-hover active:bg-accent-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-focus md:flex"
          >
            New workout
          </Link>
          <Link
