...
export default function WorkoutBuilder({
  ...
  return (
    ...
    >
              ...
              tagCatalog.map((tag) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-small border px-4 py-1 text-xs ${
                      selected
      ...
      <PendingSubmitButton
        pending={isSaving}
        className="flex h-11 items-center justify-center self-start rounded-control bg-accent px-5 text-base text-white hover:bg-accent-hover active:bg-accent-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-focus"
      >
        Save
      </PendingSubmitButton>
