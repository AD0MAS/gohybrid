      ...
      <Modal open={open} onClose={() => setOpen(false)} title={title}>
        <div className="flex flex-col gap-4">
          ...
          <div className="flex justify-end gap-3">
            ...
            <form action={action}>
              <SubmitButton className="flex h-11 items-center justify-center rounded-control bg-danger px-5 text-base text-white hover:bg-danger-hover active:bg-danger-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-focus">
                {confirmLabel}
              </SubmitButton>
            </form>
          </div>
