    ...
    >
      <div className="flex items-center justify-between border-b border-hairline p-4">
        ...
        <button
          ...
          onClick={onClose}
          aria-label="Close"
          className="rounded-md p-1 text-ink-subtle hover:bg-surface-2 hover:text-ink active:bg-surface-2 active:text-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-focus"
        >
          <X className="h-5 w-5" />
        </button>
      </div>
