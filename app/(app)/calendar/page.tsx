        ...
        {view.gridDates.map((date) => {
          ...
          return (
            <Link
              ...
              className={`flex min-h-20 flex-col gap-0.5 rounded-small border border-hairline bg-surface-1 p-1 text-xs hover:bg-surface-2 active:bg-surface-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-focus ${
