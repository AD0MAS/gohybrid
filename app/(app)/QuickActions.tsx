...
// Compact quick-action buttons: padding 11px/14px, rounded-control, 13px/500
// text, ink-muted — left-aligned, not centred, and considerably smaller than
// a section's main button (PRIMARY_BUTTON_CLASSES elsewhere on this page).
// Not accent — this page's one accent primary action is already TodayHero's
// Start workout (the accent is reserved for data and one primary action per
// view).
 ...
 * (LogPastSessionForm's no-known-workoutId branch, with a workout picker).
 * Both render at a compact size (QUICK_ACTION_CLASSES above),
