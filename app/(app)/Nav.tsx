  ...
  return (
    <>
      <nav className="fixed inset-y-0 left-0 hidden w-56 flex-col border-r border-hairline bg-canvas p-4 sm:flex">
        ...
        <div className="flex flex-col gap-2 border-t border-hairline pt-4">
          ...
          <form action={signOutAction}>
            <SubmitButton className="flex items-center gap-2 rounded-control px-3 py-2 text-sm text-ink-subtle hover:bg-surface-1 hover:text-ink active:bg-surface-1 active:text-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-focus">
      ...
      {/* z-20: must sit above the z-10 stretched-link overlays (favorite
          star, WorkoutsPage row links) and CardMenu's own z-20 popover so
          page content scrolling underneath never paints over the bar;
          stays below the z-50 FormStatus banner. */}
