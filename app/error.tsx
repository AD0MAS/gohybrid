    ...
    <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center gap-4 p-6 text-ink">
      ...
      <div className="flex gap-4">
        <button
          type="button"
          onClick={reset}
          className="rounded-control bg-accent px-4 py-2 text-sm font-medium text-white hover:bg-accent-hover active:bg-accent-hover focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-focus"
        >
          Try again
        </button>
        <Link
